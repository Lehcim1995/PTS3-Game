 ...
 */
public class SerializablePolygon implements Serializable, Shape2D
{
     ...
     */
    public SerializablePolygon(float[] vertices)
    {
     ...
     * <p>
     * Note the returned Rectangle is cached in this polygon, and will be reused if this SerializablePolygon is changed.
     *
    ...
    public Polygon getLIBGDXPolygon()
    {
